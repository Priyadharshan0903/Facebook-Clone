      ...
      <>
        ...
        <div className='rightbarFollowings'>
          ...
          <div className='rightbarFollowing'>
            ...
            <span className='rightbarFollName'>Tom Hiddleston</span>
          </div>
          <div className='rightbarFollowing'>
            <img src='assets/person/3.jpeg' alt='' className='rightbarFollImg' />
            <span className='rightbarFollName'>Chris Hemsworth</span>
          </div>
          <div className='rightbarFollowing'>
            <img src='assets/person/4.jpeg' alt='' className='rightbarFollImg' />
            <span className='rightbarFollName'>Boogieman</span>
          </div>
          <div className='rightbarFollowing'>
            <img src='assets/person/5.jpeg' alt='' className='rightbarFollImg' />
            <span className='rightbarFollName'>John cena</span>
          </div>
          <div className='rightbarFollowing'>
            <img src='assets/person/6.jpeg' alt='' className='rightbarFollImg' />
            <span className='rightbarFollName'>Dwayne Johnson</span>
          </div>
        </div>
      </>
    )
